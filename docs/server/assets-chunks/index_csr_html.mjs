...
<style>*{margin:0;padding:0}:root{--base-color:#e6e6e6;--reverse-base-color:#262626;--base-variant:#272727;--reverse-variant:#c2c2c2;--text-color:#1a1a1a;--secondary-text-color:#302f2f;--reverse-text-color:#f0f0f0;--heading-text:"Inter",sans-serif;--p-text:"Poppins",sans-serif;background-color:var(--base-color);height:100vh}body{color:var(--text-color)}</style><link rel="stylesheet" href="styles-ZG7WSFKT.css" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles-ZG7WSFKT.css"></noscript></head>
<body ngcm="">
  <app-root></app-root>
<script src="main-5SQZB453.js" type="module"></script></body>
</html>
<!--Borrar docs-->
